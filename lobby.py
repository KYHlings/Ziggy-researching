...
def lobby():
	...
	statistics = pygame.image.load('pics2//scoreboard.png')
	make_bets = pygame.image.load('pics2//make_your_bets.png')
	fight_sign = pygame.image.load('pics2//fight_sign.png')
