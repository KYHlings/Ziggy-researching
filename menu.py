...
class Mainmenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text("Main meny", 20, self.game.DISPLAY_W/2, self.game.DISPLAY_H/2 - 20)
    ...
    def move_cursor(self):
        ...
        if self.game.UP_KEY:
            ...
            if self.state == "Start":
                ...
                self.cursor_rect.midtop = (self.startx + self.offset, self.startx)
                self.state = "Start"
...
class Credits_menu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text("Made in pain", 15, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 + 10)
            self.blit_screen()
